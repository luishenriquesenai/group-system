    ...
    <div>
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                ...
                <nav class="mt-10 ">
                    <x-nav-link class="flex items-center px-6 py-2 mt-4 text-white bg-gray-500 bg-opacity-30"
                        :href="route('customers.index')" :active="request()->routeIs('customers.index')">
