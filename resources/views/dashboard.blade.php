<x-app-layout>
                                ...
                                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                                    <li>
                                        <button data-modal-target="addReserva" data-modal-toggle="addReserva"
                                            class="flex items-center w-full p-3 text-white transition duration-75  pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Reservas</button>
                                    </li>
                                    <li>
                                        <button data-modal-target="addSP" data-modal-toggle="addSP"
                                            class="flex items-center w-full p-3 text-white transition duration-75  pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Serviços Prestados</button>
                                    </li>
                                    <li>
                                        <button data-modal-target="addCliente" data-modal-toggle="addCliente"
                                            class="flex items-center w-full p-3 text-white transition duration-75  pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Clientes</button>
                                    </li>
                                </ul>
                            </li>
    ...
    <div id="addReserva" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Serviço adiquirido</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data da reserva</label>
    ...
    <div id="addSP" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
    ...
    <div id="addCliente" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
