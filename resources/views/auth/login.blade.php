            ...
            <div class="relative py-6 sm:w-96 mx-auto mb-24 text-center">
                ...
                <div class=" bg-white shadow-md rounded-lg text-left">
                    ...
                    <div class="px-8 py-6 ">
                        ...
                        <x-text-input id="password" placeholder="Password" class="border w-full h-5 px-3 py-5 mt-2 focus:outline-none focus:ring-0 focus:border-verde_logo rounded-md" type="password" name="password" required autocomplete="current-password" />
                        <div class="block mt-4">
                            <label for="remember_me" class="inline-flex items-center">
                                <input id="remember_me" type="checkbox" class="rounded dark:bg-white border-black dark:border-black text-indigo-600 focus:ring-0 " name="remember">
                        ...
                        <div class="flex justify-between items-baseline">
                            ...
                            <button type="submit" class="mt-4 bg-verde_logo text-white py-2 px-6 rounded-md hover:verde_logo ">Login</button>
